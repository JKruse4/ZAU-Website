...
<header>
	<div class="container">
		<div class="row">
			<div class="col-md-9">
		 <a href="https://zjxartcc.org"><img src="https://zjxartcc.org/assets/images/logo.png" alt="vZJX Forum" width="312" height="80"></a>
	 </div>
			<div class="col-md-3">';
...
// Generate a strip of mod buttons.
function template_button_mod_strip($button_strip, $direction = 'top', $strip_options = array())
{
	global $settings, $context, $txt, $scripturl;
	...
	echo '
		<div class="btn-group', !empty($direction) ? ' navbar-' . $direction : '', '"', (empty($buttons) ? ' style="display: none;"' : ''), (!empty($strip_options['id']) ? ' id="' . $strip_options['id'] . '"': ''), '>
			<button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown">
				 Moderation Actions <b class="caret"></b>
			  </button>
			<ul class="dropdown-menu" role="menu">',
				implode('', $buttons), '
			</ul>
